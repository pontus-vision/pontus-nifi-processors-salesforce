...
public class GenerateSOQL extends AbstractSalesforceRESTOperation {
    ...
    protected void init(final ProcessorInitializationContext context) {
        final List<PropertyDescriptor> descriptors = new ArrayList<PropertyDescriptor>(this.descriptors);
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        session.read(flowFile, new InputStreamCallback() {
            ...
            public void process(InputStream inputStream) throws IOException {
                String jsonString = IOUtils.toString(inputStream, Charsets.UTF_8);
